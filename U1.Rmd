...
Con la cual, bajo el nombre de _R-squared_, aparece nuestro valor ya obtenido. Es importante notar que aparecen dos de estos. El primero (_Multiple..._) es el que tomamos para modelos que solo contengan una variable dependiente y otra independiente. El segudno (_Ajusted..._) es útil para modelos multivariables.
