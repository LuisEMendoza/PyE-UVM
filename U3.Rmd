...
$$
E(x)=\mu=n \left(\begin{array}{c}r\\ N \end{array} \right)\\
Var(x)=\sigma^2=n \left(\begin{array}{c}r\\ N \end{array} \right) \left(1- \begin{array}{c}r\\ N \end{array} \right) \left(\begin{array}{c}N-n\\ N-1 \end{array} \right)
$$
