...
```{r}
d <- combn(53,6) #asignemos el resultado a una variable 'c'
ncol(d) #solo queremos que nos cuente las columnas y nos lo diga
```
...
Podemos darnos cuenta que la probabilidad de ser ascendido dado que se es mujer es la mitad de la probabilidad para el hombre. Esto no prueba cabalmente que exista discriminación, pero sí confirma las sospechas y el argumento de las mujeres. Dentro del punto de vista probabilístico, no existe justicia en los ascensos.
...
$A_2$|$0.35$|$0.05$|$0.1750$|$0.01750/0.0305=0.5738$
